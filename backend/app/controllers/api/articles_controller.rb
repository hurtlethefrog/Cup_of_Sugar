class Api::ArticlesController < ApplicationController
  ...
  #     new_id = {:id => generateID(article.id, article.type)}
  ...
  #     output = modified_articles.merge(new_id).merge(owner_hash).merge(comments_hash).merge(attendees_hash)
